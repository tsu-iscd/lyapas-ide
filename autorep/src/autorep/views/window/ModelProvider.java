...
public enum ModelProvider {
        ...
        private ModelProvider() {
        	...
        	LSymbols.add(new LSymbol("⇕", "Transposition", "^\\/", "Unicode:  U+21d5\nExample: ⇕L\nDescription: transposition"));        	
